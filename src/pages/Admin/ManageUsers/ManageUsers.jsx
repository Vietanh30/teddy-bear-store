        ...
        <>
            ...
            <div className="p-6 sm:ml-60 min-h-screen mt-20 bg-gray-100">
                <div className="flex justify-between items-center mb-4">
                    <h2 className="text-2xl font-bold text-[#ff6683]">Quản lý Người Dùng</h2>
                    <button onClick={() => setShowAddModal(true)} className="bg-[#ff6683] text-white px-4 py-2 rounded-lg hover:bg-pink-600">
                        + Thêm người dùng
                    </button>
                </div>
                ...
                <div className="flex mb-4">
                    ...
                    />
                    <button onClick={handleSearch} className="bg-[#ff6683] text-white px-4 rounded-r-md">
                        Tìm
                    </button>
                </div>

                {loading ? (
                    <p className="text-center text-[#ff6683] font-semibold">Đang tải danh sách...</p>
                ) : users.length > 0 ? (
                    ...
                    <p className="text-center text-[#ff6683] font-semibold mt-6">Không có người dùng nào</p>
                )}
                    ...
                    <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
                        <div className="bg-white p-6 rounded-lg w-full max-w-md">
                            ...
                            <div className="flex justify-end mt-4 space-x-2">
                                ...
                                }} className="bg-[#ff6683] text-white px-4 py-2 rounded-md">Lưu</button>
                            </div>
                        ...
                        <div className="bg-white p-6 rounded-lg w-full max-w-md">
                            ...
                            <div className="flex justify-end mt-4 space-x-2">
                                ...
                                <button
                                    ...
                                    className="bg-[#ff6683] text-white px-4 py-2 rounded-md"
                                >
                                    Cập nhật
                                </button>
                            </div>
