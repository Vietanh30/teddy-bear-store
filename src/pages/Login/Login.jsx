...
const Login = () => {
    ...
    const LoadingButton = ({ isLoading, text, type = "submit" }) => (
        <button
            type={type}
            className="px-8 mt-2 font-bold rounded-3xl py-2 bg-[#ff6683] text-white hover:bg-[#02c4c1] transition-colors duration-300 disabled:opacity-70 disabled:cursor-not-allowed"
            disabled={isLoading}
        >
            {isLoading ? (
                ...
                <div className={styles["panels-container"]}>
                    <div className={`${styles.panel} ${styles["left-panel"]}`}>
                        <div className={styles.content}>
                            ...
                            <p>Hãy đăng ký ngay để nhận nhiều ưu đãi khi mua gấu bông tại cửa hàng!</p>
                            <button
                    ...
                    <div className={`${styles.panel} ${styles["right-panel"]}`}>
                        <div className={styles.content}>
                            ...
                            <p>Đăng nhập ngay để tiếp tục mua sắm những mẫu gấu bông đáng yêu!</p>
                            <button
                                className={`${styles.btn} ${styles.transparent}`}
