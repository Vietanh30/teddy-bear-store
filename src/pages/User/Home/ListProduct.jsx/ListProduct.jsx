        ...
        <div className="container mx-auto mt-10">
            ...
            {isLoading ? (
                <div className="flex justify-center items-center h-60">
                    <div className="animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-[#ff6683]"></div>
                </div>
            ) : (
                <>
                    ...
                    {categories.map((category) => {
                        ...
                        return (
                            <div key={category.id} className="mb-16">
                                {/* Category title */}
                                <div className="text-center text-2xl font-black text-[#ff6683]">
                                    BST {category.name}
                                </div>
                                ...
                                {categoryProducts.length > 0 ? (
                                    <>
                                        ...
                                        <div className="mt-8 flex justify-center">
                                            <button className="uppercase flex items-center text-sm font-bold px-5 py-2 bg-[#ff6683] rounded-lg text-white transition-colors duration-300 hover:bg-[#02c4c1]">
                                                <span>
                                                    Xem tất cả BST {category.name}
                                                </span>
                                            </button>
                                        </div>
                                    </>
