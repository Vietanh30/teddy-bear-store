    ...
    return (
        <div className="mt-8">
            ...
            <form onSubmit={handleCommentSubmit} className="mb-6 p-4 border rounded-lg w-full">
                ...
                <button
                    type="submit"
                    className="bg-[#F15E9A] text-white py-2 px-4 rounded hover:bg-pink-600 transition disabled:opacity-60 disabled:cursor-not-allowed"
                    ...
                    {hasMore && (
                        <div className="flex justify-center mt-6">
                            <button
                                ...
                                className="px-6 py-2 border border-[#F15E9A] text-[#F15E9A] rounded-full hover:bg-[#F15E9A] hover:text-white transition duration-300"
                            >
                                Xem thêm đánh giá
                            </button>
                        </div>
