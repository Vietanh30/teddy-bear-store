        ...
        <>
            ...
            <div className="container mx-auto mt-6 mb-10">
                <nav className="text-sm flex items-center gap-2">
                    <Link to={path.home} className="hover:text-[#02c4c1] transition">Trang chủ</Link>
                    <span>&gt;</span>
                    <span className="text-gray-600">Thông tin cá nhân</span>
                </nav>

                <div className="text-2xl font-bold text-[#ff6683] uppercase mt-6 text-center">
                    Thông tin cá nhân
                </div>
                <div className="my-4 border-b border-[#ff6683] w-24 mx-auto"></div>
                    ...
                    <div className="space-y-4">
                        <div>
                            ...
                            <input
                                ...
                                className="w-full border px-3 py-2 rounded-lg focus:ring-2 focus:ring-[#ff6683] transition"
                                disabled={!isEditing}
                            />
                        </div>
                    ...
                    <div className="flex justify-end gap-3 mt-6">
                        {isEditing ? (
                            <>
                                ...
                                <button
                                    className="bg-[#ff6683] text-white px-4 py-2 rounded-lg hover:bg-[#02c4c1] transition"
                                    onClick={handleSave}
                                >
                                    Lưu
                                </button>
                            ...
                            <button
                                className="bg-[#02c4c1] text-white px-4 py-2 rounded-lg hover:bg-[#ff6683] transition"
